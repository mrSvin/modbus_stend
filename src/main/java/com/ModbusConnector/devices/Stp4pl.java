...
public class Stp4pl {
    ...
    private String complexTable = "stp4pl_days";
    ...
    public void data() {
        ...
        try {
            modbusClient = new ModbusClient("192.168.17.147", 502);
        ...
        try {
            ...
            Thread thread = new Thread(() -> {
                ...
                try {
                    ...
                    int[] test = modbusClient.ReadHoldingRegisters(10, 1);
...
//                    e.printStackTrace();
    ...
    private int findStatus(List<List> parserData) {
        ...
        //0 - Установка не активна 1 - Установка готова к работе 2 - Установка работает (выполняет движения, но не варит) 3 - Установка в аварии 4 - Установка варит
        if (state1 == 2) {
            return 1;
        } else if (state1 == 4) {
            return 5;
