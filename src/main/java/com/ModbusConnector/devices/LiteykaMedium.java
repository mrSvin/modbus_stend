...
public class LiteykaMedium {
    ...
    private String complexTable = "liteyka_medium_days";
    ...
    public void data() {
        ...
        try {
            modbusClient = new ModbusClient("192.168.17.57", 777);
        ...
        try {
            ...
            Thread thread = new Thread(() -> {
                ...
                try {
                    ...
                    //System.out.println("cikl: " + intValues.get(0));
...
//                    e.printStackTrace();
    ...
    private int findStatus(List<List> parserData) {
        int cikl = (int) parserData.get(0).get(0);
