...
public class Kv12 {
    ...
    private String complexTable = "kv12_days";
    ...
    public void data() {
        ...
        try {
            modbusClient = new ModbusClient("192.168.17.94", 777);
...
//                    e.printStackTrace();
    ...
    private void writeRabotaArray(int status) {
        ...
        if (status == 1 && triger_work != 1) {
            ...
            int tabel = (int) parserData.get(0).get(0);
            programname_arrayList.add(String.valueOf(tabel));
        }
